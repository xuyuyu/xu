        ...
        <td>
            <div class="container">
                <div class="row">
                    ...
                    <form action="${pageContext.request.contextPath}/CartServlet?method=putInCart" method="post">
                        ...
                        <div style="margin:0 auto;width:950px;"style="float:left;">
                            <div class="col-md-6">
                                ...
                                <div class="col-md-6" style="float: right;">
                                    ...
                                    <div style="margin:10px 0 10px 0;">亿家价: <strong style="color:#ef0101;">￥：${requestScope.product.shop_price}</strong> 参 考 价： <del>￥${requestScope.product.market_price}</del>
                                    </div>
                                    ...
                                    <div style="padding:10px;border:1px solid #e7dbb1;width:330px;margin:15px 0 10px 0;;background-color: #fffee6;">
                                        <div style="margin:5px 0 10px 0;">${requestScope.product.pro_color}</div>
                    ...
                    <div style="width:950px;margin:0 auto;">
                        ...
                        <div>
                            <img width="600px" height="500px" src="${pageContext.request.contextPath}/${requestScope.product.pro_max_img}">
                        </div>
                    </div>
